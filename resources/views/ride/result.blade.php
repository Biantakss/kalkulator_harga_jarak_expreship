...
<div class="container">
    ...
    <div class="alert alert-info">
        ...
        <strong>Jenis Kelamin:</strong>{{ $ride->gender }}<br>
    ...
    <a href="https://wa.me/+6287841274541?text=Hallo%20Shipmin%20saya%20mau%20diantar%20pakai%20layanan%20ShipRide!%0A%0ADengan%20Format%20Order%0ANama%20:%20{{ urlencode($ride->name) }}%0ANo%20WA%20:%20{{ urlencode($ride->phone_number) }}%0AJenis%20Kelamin%20:%20{{ urlencode($ride->gender) }}%0AAlamat%20Penjemputan%20:%20{{ urlencode($ride->pickup_location) }}%0AAlamat%20Tujuan%20:%20{{ urlencode($ride->dropoff_location) }}%0AWaktu%20Penjemputan%20(Tgl%20%26%20Jam)%20:%20{{ urlencode($ride->pickup_time) }}%0AHarga%20Ongkir%20:%20Rp%20{{ urlencode(number_format($ride->price, 0, ',', '.')) }}"
